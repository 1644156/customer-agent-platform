...
class ActionDefaultFallback(Action):
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        from customer_agent.dialogue_understanding.stack.stack_frame import CannotHandleStackFrame
...
class ActionChitChatResponse(Action):
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        from customer_agent.dialogue_understanding.stack.stack_frame import ChitChatStackFrame
...
class ActionSendText(Action):
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        if text:
            response_kwargs = {}
            for key in ("citations", "image_urls", "source", "session_id", "query_type", "crag_decision"):
                if key in kwargs:
                    response_kwargs[key] = kwargs[key]
            result.add_response(text, **response_kwargs)
...
class ActionHumanHandoff(Action):
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        from customer_agent.dialogue_understanding.stack.stack_frame import HumanHandoffStackFrame
...
class ActionTriggerSearch(Action):
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        from customer_agent.dialogue_understanding.stack.stack_frame import SearchStackFrame
...
class ActionFlowCompleted(Action):
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        from customer_agent.dialogue_understanding.stack.stack_frame import CompletedStackFrame
