...
from customer_agent.dialogue_understanding.flow.flow import Flow, FlowsList
from customer_agent.shared.yaml_loader import read_yaml_file, read_yaml_files
from customer_agent.shared.exceptions import ConfigurationException
...
class FlowLoader:
    ...
    def load_from_string(self, yaml_string: str) -> FlowsList:
        ...
        Returns:
            FlowsList实例
        """
        from customer_agent.shared.yaml_loader import read_yaml_string
