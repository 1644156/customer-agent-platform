...
from customer_agent.dialogue_understanding.generator.prompt_builder import PromptBuilder
from customer_agent.dialogue_understanding.generator.command_parser import (
    CommandParser,
    ParseResult,
)
from customer_agent.dialogue_understanding.commands.answer_commands import CannotHandleCommand
from customer_agent.dialogue_understanding.commands.error_commands import (
    ErrorCommand,
    InternalErrorCommand,
)
from customer_agent.shared.llm import create_llm_client
from customer_agent.shared.llm.base_client import LLMClient, LLMResponse
from customer_agent.shared.exceptions import LLMException
...
class LLMCommandGenerator(CommandGenerator):
    ...
    def from_config(cls, config: Dict[str, Any]) -> "LLMCommandGenerator":
        ...
        generator_config = LLMGeneratorConfig(
            type=config.get("type", config.get("provider", "openai")),
