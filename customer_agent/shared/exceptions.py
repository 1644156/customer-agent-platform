...
所有异常都继承自CustomerAgentException基类。
"""

from typing import Optional, Text


class CustomerAgentException(Exception):
    """customer_agent系统的基础异常类
...
class ConfigurationException(CustomerAgentException):
    """配置异常
...
class ModelNotFound(CustomerAgentException):
    """模型未找到异常
...
class ModelLoadException(CustomerAgentException):
    """模型加载异常
...
class ModelTrainingException(CustomerAgentException):
    """模型训练异常
...
class LLMException(CustomerAgentException):
    """LLM异常基类
...
class TrackerStoreException(CustomerAgentException):
    """Tracker存储异常基类
...
class DialogueUnderstandingException(CustomerAgentException):
    """对话理解异常基类
...
class ActionException(CustomerAgentException):
    """Action异常基类
...
class ChannelException(CustomerAgentException):
    """通道异常基类
...
class GraphException(CustomerAgentException):
    """图引擎异常基类
...
class RetrievalException(CustomerAgentException):
    """检索异常基类
...
class ValidationException(CustomerAgentException):
    """验证异常基类
