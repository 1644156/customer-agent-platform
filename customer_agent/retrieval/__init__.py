...
from customer_agent.retrieval.base_retriever import (
    InformationRetrieval,
    Retriever,  # 向后兼容别名
    SearchResult,
    Document,
)
from customer_agent.retrieval.embedder import (
    Embedder,
    EmbedderConfig,
    OpenAIEmbedder,
    LocalEmbedder,
...
from customer_agent.retrieval.flow_retriever import FlowRetriever, FlowDocument
